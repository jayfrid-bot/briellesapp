...
This app uses some free pictures that other kind people made and shared.
...
- **three.js** (3D library) and **OrbitControls** — free, open-source (MIT license).
  Files: `libs/three.min.js`, `libs/OrbitControls.js`

---
When you add a new picture, write down where you got it here, too! 😊
